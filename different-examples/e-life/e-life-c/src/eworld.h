...
// // получение доступа к введнному образу карты
// char* GetLoadedMapPtr() { return &textMap; }
// // Формирование начального состояния списка активных сущностей
// void CreateActiveEntitiesList();
// // Моделирование очередного шага жизни
// void MakeStep();
// // Добавление активной сущности к списку
// void AppendMe(Entity* e);
// // Удаление активной сущности из списка по ее известным координатам
// void EraseEntity(int iNew, int jNew);
// // Восстановление исходного состояния Э-мира
// void Restore();
